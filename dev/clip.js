...
shape_array = {
  "polygon" : [
    {
      name : "Triangle",
      coords : [[50,3],[57,3],[65,5],[73,7],[80,10],[85,15],[90,22],[95,29],[100,35],[100,43],[100,50],[100,60],[100,70],[95,75],[90,80],[85,85],[80,90],[73,93],[65,95],[57,97],[50,100],[43,97],[35,95],[27,93],[20,90],[14,85],[7,80],[0,75],[0,70],[0,60],[0,50],[0,42],[0,35],[4,30],[7,25],[10,19],[13,13],[20,10],[28,7],[35,5],[43,2]]
    },
    {
      name : "Trapezoid",
...
image = url;
  var style = '#element0:before { background-image: url(' + url + '); }';
...
function setCustomBackgroundCanvas(url) {
image = url;
  var style = '#myCanvas { background-image: url(' + url + ');background-size:'+resize+' }';
  $("#custom_canvas").html(style);
...
function setCustomBright() {
  var style = '#element0:before { filter: brightness(' + bright/10 + '); }';
  $("#custom_bright").html(style);

  // Scroll to top of page
  scrollTop();
}
function setCustomResize() {
  var style = '#element0:before { background-size: '+resize+'px; }';
  $("#custom_resize").html(style);

  // Scroll to top of page
  scrollTop();
}
function setCustomRotate() {
  var style = '#element0:before { transform: rotate('+rotate+'deg); }';
  $("#custom_rotate").html(style);
...
function clipIt() {
  ...
  $("#element0b").css("clip-path",$("#element0").css("clip-path"))
  resizeImage(resize);
}
